        ...
        <div className="relative mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
          <div className="grid items-end gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              ...
              <h1 className="mt-5 text-4xl font-semibold leading-[1.02] tracking-[-0.06em] text-foreground sm:text-5xl lg:text-6xl">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link
                  href="#library"
                  className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-[0_18px_40px_-24px_rgba(63,132,184,0.9)] transition hover:-translate-y-0.5 hover:opacity-95"
                >
                  Browse library
                  <ArrowRight size={16} />
                </Link>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-full border border-border bg-background/75 px-6 py-3.5 text-sm font-semibold text-foreground/80 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/40 hover:text-primary"
                >
                  Book consultation
                </Link>
              </div>
            ...
            <div
              className={`grid gap-4 transition-all duration-700 ease-out delay-150 sm:grid-cols-3 lg:grid-cols-1 ${
                isVisible ? "translate-y-0 opacity-100" : "translate-y-5 opacity-0"
              }`}
            >
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-[1.5rem] border border-border/70 bg-background/80 p-5 shadow-[0_16px_45px_-32px_rgba(15,23,42,0.3)] backdrop-blur"
                >
          ...
          <div className="mt-10">
            ...
            >
              <div className="flex items-center justify-between gap-4 border-b border-border/70 px-5 py-4 sm:px-6">
                ...
                <span className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-primary/10 px-3 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                  <Sparkles size={14} />
                  Highlight
                </span>
              </div>
              ...
              <div className="px-4 pb-4 pt-6 sm:px-6 sm:pb-6 sm:pt-8">
                <div
                  key={featuredAnimKey}
                  className="soft-rise relative overflow-hidden rounded-[1.8rem] border border-border/70 bg-surface/80"
                >
                  <video
                    key={activeVideo.src}
                    src={activeVideo.src}
                    className="aspect-[21/8.8] w-full object-contain"
                    muted
                    playsInline
                    controls
                    preload="metadata"
                  ...
                  <div className="absolute left-4 top-4 inline-flex items-center gap-2 rounded-full bg-background/90 px-3 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-foreground shadow-[0_14px_30px_-20px_rgba(15,23,42,0.35)] backdrop-blur">
                ...
                <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-background/75 px-5 py-3 text-sm font-semibold text-foreground/80 transition hover:-translate-y-0.5 hover:border-primary/40 hover:text-primary"
                  >
                    Ask about videos
                    <ArrowRight size={16} />
                  </Link>
          ...
          <div id="library" className="mt-10">
            <div
              className={`flex items-end justify-between gap-4 transition-all duration-700 ease-out delay-500 ${
                isVisible ? "translate-y-0 opacity-100" : "translate-y-5 opacity-0"
              }`}
            >
              <div>
              ...
              <p className="hidden max-w-md text-sm leading-7 text-foreground/60 md:block">
