...
const fallbackItems: ClinicScheduleItem[] = [
  {
    title: "Clemenceau Medical Center (CMC)",
    description: "Beirut center",
    workDays: "Monday - Thursday",
  },
  {
    title: "LAU Medical Center - Rizk Hospital",
    description: "Beirut center",
    workDays: "Wednesday",
  },
  {
    title: "Makassed General Hospital",
    description: "Beirut center",
    workDays: "Wednesday",
  },
  {
    title: "Rosary Sisters Hospital",
    description: "Beirut center",
    workDays: "Thursday",
  },
  {
    title: "Abyad Medical Center",
    description: "Tripoli center",
    workDays: "Saturday",
  },
  {
    title: "Clemenceau Medical Center (CMC)",
    description: "Dubai center",
    workDays: "By appointment",
  },
];
...
const normalizeCity = (description: string) =>
  description.replace(/\s*center\s*$/i, "").trim() || "Clinic";

const getScheduleItems = (entry?: ClinicScheduleEntry | null) => {
...
export default function ClinicSchedule() {
  ...
  const [scheduleEntry, setScheduleEntry] = useState<ClinicScheduleEntry | null>(null);
  ...
  const locations = useMemo(() => getScheduleItems(scheduleEntry), [scheduleEntry]);

  const cityGroups = useMemo<CityGroup[]>(() => {
    const grouped = locations.reduce<Record<string, ClinicScheduleItem[]>>(
      (acc, location) => {
        const city = normalizeCity(location.description);
